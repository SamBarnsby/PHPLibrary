...
<html>
    ...
    <body>
       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light navbar navbar-dark bg-dark">
                  ...
                  <li class="nav-item">
                    <?php
                            if(isset($_SESSION['login_user']) and (isset($_SESSION['user_type']) and (($_SESSION['user_type']== 1)))) {
                                echo  "<a class=" . '"nav-link active"' .  "href=" . '"userlist.php"' . ">User List</a>";
        ...
        <?php 
            if(isset($_SESSION['user_type']) and (($_SESSION['user_type']== 1) or ($_SESSION['user_type']== 2))) {
                echo "<a href=" . '"add_user.php?id=0"' . "type=" . '"button"' . "class=" . '"btn btn-outline-primary"' . ">" . "Add User" . "</a>";
                }
        ?>
        <br/>
        <br/>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                        <?php 
                            ...
                            $sentenciaSQL = "SELECT ID, Name, Email, User_type FROM user;";
                            ...
                            if(isset($_SESSION['user_type']) and ($_SESSION['user_type']== 1)) {
                                while ($row = $registros->fetch_assoc()){
                                    echo "<tr>"; 
                                        ...
                                        echo "<td>" .  "<a href=" . '"add_user.php?id=' . $row['ID'] . '"' . ">" . "<img src=" . '"images/edit_user.png"' . "/>" . "</a>" . "</td>";
                                        echo "<td>" .  "<a href=" . '"delete.php?type=user&id=' . $row['ID'] . '"' . ">" . "<img src=" . '"images/delete.png"' . "/>" . "</a>" . "</td>"; 
                                        $increment++;
                                    echo "</tr>";
                                }
                            }
